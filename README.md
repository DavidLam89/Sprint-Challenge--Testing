...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    ...
    Describe() can be nested so it's used to break the test suite into components. It() is where individual tests are performed.  

1. What is the point of `Test Driven Development`? What do you think about this approach?

    In TDD, tests are written before writing  code needed for the tests to pass. The reason behind TDD is to achieve good quality code and good test coverage. One downside of this approach is the test and the code are written by the same developer. To produce meaningful tests, there should be another person do the testing.

1. Mention three types of automated tests.

    Unit test, component testing, snapshot testing
